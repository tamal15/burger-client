...
const UserProfile = () => {
    ...
    useEffect(() => {
        fetch(`https://burger-backend-production.up.railway.app/updateUser/${user.email}`)
            .then(res => res.json())
            .then(data => {
                setUserInfo(data)
                console.log(data)
    ...
    return (
        <div className='user-profile ' style={{background:"#032831",borderRadius:"20px", margin:"9px"}}>
