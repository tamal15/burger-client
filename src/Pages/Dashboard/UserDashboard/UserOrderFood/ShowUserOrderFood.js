...
const ShowUserOrderFood = () => {
    ...
    const fetchData = () => {
      fetch('https://burger-backend-production.up.railway.app/userOrder')
        .then(res => res.json())
                ...
                <Grid  container spacing={2} columns={{ xs: 4, sm: 8, md: 4 }}>
                  ...
                  <Grid item xs={2} sm={4} md={8} pl={2} my={3}>
                    <Box style={{textAlign:"left"}}>
                      ...
                      <h5 style={{fontWeight:"700"}}>Email : {single?.email}</h5>
                      <h5 style={{fontWeight:"700"}}>Quantity : {single?.quantity}</h5>
                      <h5 style={{fontWeight:"700"}}>Branch : {single?.branch}</h5>
                      <h5 style={{fontWeight:"700"}}>Product : {single?.product}</h5>
...
export default ShowUserOrderFood;