...
const UserOrderFood = () => {
    ...
    const onSubmit = data => {
        ...
        fetch("https://burger-backend-production.up.railway.app/orderFood", {
            method: "POST",
                ...
                <Row>
                    <Col md={{ span: 8, offset: 2 }}>
                        <div className="login-form text-center shadow" style={{background:"#032831",borderRadius:"20px"}}>
                            <h2 className='mb-5 text-white'>Add Your Order Food</h2>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <input
                                style={{fontWeight:"600",color:" #0E1621"}}
                                className='w-75 mb-3'  {...register("quantity", { required: true })} placeholder='Quantity: 1/2 inche' /> <br />
                                <input
                                style={{fontWeight:"600",color:" #0E1621"}}
                                className='w-75 mb-3'  {...register("branch", { required: true })} placeholder='Branch' /> <br />
                                <input
                                style={{fontWeight:"600",color:" #0E1621"}}
                                className='w-75 mb-3'  {...register("product", { required: true })} placeholder='burger/pasta/pizza' /> <br />
                                <input
                                style={{fontWeight:"600",color:" #0E1621"}}
