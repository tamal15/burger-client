...
//   import { alert, ButtonStyle } from "../../Hooks/useStyle";
  ...
  const PizzaPastaDetails = () => {
    ...
    useEffect(() => {
      fetch(`http://localhost:5000/Detailsproduct/${id}`)
        .then((res) => res.json())
    ...
    const onSubmit = (data) => {
        ...
        fetch("https://burger-backend-production.up.railway.app/review", {
            method: "POST",
            headers: {
  ...
  export default PizzaPastaDetails;