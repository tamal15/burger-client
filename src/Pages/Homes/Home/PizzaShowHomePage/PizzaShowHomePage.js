...
import '../BuyerProducts/BuyerProducts.css'
...
const PizzaShowHomePage = () => {
    ...
    const fetchData = () => {
      fetch('https://burger-backend-production.up.railway.app/PostUploadpizza')
        .then(res => res.json())
...
export default PizzaShowHomePage;