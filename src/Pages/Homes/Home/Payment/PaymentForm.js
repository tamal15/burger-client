...
import useAuth from "../../../../hooks/useAuth";
import CartCalculation from "../../../../Hook/UseCartCalculation";
...
const handleCloses = () => setOpens(false);
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post('https://burger-backend-production.up.railway.app/init', paymentData)
      .then((res) => {
...
<h4 style={{textAlign:"", fontWeight:"700"}}>Share Purchase</h4>
<p style={{textAlign:"", fontSize:"13px",fontWeight:"600"}}>If you want to buy the product as a share Product, then do Share Product purchase.  And if you don't want to buy the product as a Share, ignore it.</p>
{/* <div> */}
{/* disabled={'true' ||'false'} */}
<Button  className="week-design" style={{background:"", padding:"", fontSize:""}} onClick={handleOpen}>Share</Button>
<Modal
...
<p style={{textAlign:"", fontSize:"13px",fontWeight:"600"}}>If you want to buy the product as a Schedule Product, then do Schedule Product purchase.  And if you don't want to buy the product as a Schedule, ignore it.</p>
{/* <div> */}
{/* disabled={'true' ||'false'} */}
<Button  className="week-design" style={{background:"#032831", padding:"", fontSize:""}} onClick={handleOpens}>Schedule</Button>
<Modal
aria-labelledby="transition-modal-title"
aria-describedby="transition-modal-description"
open={opens}
