                            ...
                            <div className="footer-box">
                                ...
                                <div className="links mt-4">
                                    <ul>
                                        ...
                                        <Link style={{textDecoration:"none"}} to={'/allSyllabus'}><li> <FaArrowRight className='link-icon' />Burger</li></Link>
                                        <Link style={{textDecoration:"none"}} to={'/'}><li> <FaArrowRight className='link-icon' />Pizza</li></Link>
                                        <Link style={{textDecoration:"none"}} to={'/'}><li> <FaArrowRight className='link-icon' />Pasta</li></Link>
                                        <Link style={{textDecoration:"none"}} to={'/'}><li> <FaArrowRight className='link-icon' />Dashboard</li></Link>
                                    </ul>
                                </div>
                            </div>
                        </Col>
                                ...
                                <div className="links mt-4">
                                    <ul>
                                        <Link style={{textDecoration:"none"}} to={'/allBooks'}>
                                            <li> <FaArrowRight className='link-icon' />Profile</li>
                                        </Link>
                                        <Link style={{textDecoration:"none"}} to='/dashboard/welcome'>
                                            <li> <FaArrowRight className='link-icon' />Home</li>
                                        </Link>
                                        <Link style={{textDecoration:"none"}} to='/dashboard/user-profile'>
                                            <li> <FaArrowRight className='link-icon' />About</li>
                                        </Link>
                                        <Link style={{textDecoration:"none"}} to='/dashboard/my-questions'>
                                            <li> <FaArrowRight className='link-icon' />Product</li>
                                        </Link>
                                        <Link style={{textDecoration:"none"}} to='/dashboard/my-notes'>
                                            <li> <FaArrowRight className='link-icon' />Site</li>
                                        </Link>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <Row>
                        <Col>
                            <p className="copyright-text text-center mt-2">
                                All right reserved &copy; PIZZAHUB 2022
                            </p>
                        </Col>
                    </Row>
                </Container>
