            ...
            <Container sx={{ height: '100%', position: 'relative', overflow: 'hidden' }}>
                <Grid container spacing={4} sx={{ height: '100%' }} alignItems='center'>
                    <Grid item md={6} xs={12}>
                        <Typography color="#46AADC" gutterBottom variant='h3' sx={{ fontWeight: '900' ,textAlign:"left"}}>Let's grow together.</Typography>
                        <Typography color="#46AADC" gutterBottom variant='body1' sx={{textAlign:"left"}}>We're building a culture at service A to Z where amazing people (like you) can do their best work. If you're ready to grow your career and help millions of organizations grow better, you've come to the right place.</Typography>
                        <Button
                        className='last me-5'
                            component={NavLink}
